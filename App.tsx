        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center h-auto sm:h-16 py-2 sm:py-0 gap-3 sm:gap-0">
            <div className="flex items-center gap-6">
                ...
                <nav className="flex gap-2 items-center sm:border-l sm:border-gray-800 sm:pl-6">
                     ...
                     {/* LAB BUTTON */}
                     <a href="https://mistercuarter.es/laboratoria" target="_blank" rel="noreferrer" className={`${headerBtnClass} border-purple-900/30 hover:shadow-[0_0_10px_rgba(168,85,247,0.2)] hidden md:flex`}>
                     ...
                     {/* NEO BUTTON */}
                     <a href="https://neo.mistercuarter.es" target="_blank" rel="noreferrer" className={`${headerBtnClass} border-green-900/30 hover:shadow-[0_0_10px_rgba(34,197,94,0.2)] hidden md:flex`}>
                        <svg className="w-3 h-3 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" /></svg>
                        <span className="text-[10px] font-bold font-mono tracking-wider text-gray-400 group-hover:text-green-400 transition-colors uppercase">{t.navNeo}</span>
                     </a>

                     {/* NEURAL QUIZ BUTTON */}
                     <a href="https://neuralquiz.mistercuarter.es" target="_blank" rel="noreferrer" className={`${headerBtnClass} border-rose-900/30 hover:shadow-[0_0_10px_rgba(244,63,94,0.2)] hidden md:flex`}>
                        ...
                        <span className="text-[10px] font-bold font-mono tracking-wider text-gray-400 group-hover:text-rose-400 transition-colors uppercase">NEURAL QUIZ</span>
                     </a>
                </nav>
            </div>
